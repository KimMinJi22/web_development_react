...
// 두 번째 argument는 배열이므로 내부에 다양한 element가 들어갈 수 있고, 여러 상태 값 중 하나만
// 변경되더라고 useEffect의 콜백함수가 호출되도록 작성할 수도 있습니다.
...
// 즉 useEffect의 두 번째 argument인 count 값이 바뀌지 않았기 때문에 cleanup이 일어나지
// 않았습니다
// 이후 버튼을 눌러 count 값을 +1 시킬 때마다(즉 count 상태 값을 바꿀 때마다) Clean Up
// Function이 먼저 콘솔에 찍히고, 이후에 Hello from useEffect가 출력됨을 확인할 수 있습니다.
